...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "censored_politicss")
BOT_USERNAME = os.getenv("BOT_USERNAME", "expose_song_bot")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/THE_EXPOSE_NET")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/EXPOSE_SUPPORT")
INSTAGRAM = os.getenv("INSTAGRAM", "https://t.me/censored_krishan")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/censored_krishan")
GITHUB = os.getenv("GITHUB", "https://t.me/censored_krishan")
DONATE = os.getenv("DONATE", "https://t.me/censored_krishan")
